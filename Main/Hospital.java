...
public class Hospital extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Welcome To Patient Information System!");
        setResizable(false);
        setSize(new java.awt.Dimension(800, 480));

        MainF.setBorder(new javax.swing.border.MatteBorder(null));
        MainF.setToolTipText("");
        MainF.setName("PIS"); // NOI18N

        jPanel1.setBackground(new java.awt.Color(142, 215, 44));
        ...
        mLabel.setBackground(new java.awt.Color(32, 141, 35));
        mLabel.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        mLabel.setForeground(new java.awt.Color(255, 255, 255));
        mLabel.setText("Patient Information System");

        jPanel2.setBackground(new java.awt.Color(231, 86, 86));
        ...
        jPanel3.setBackground(new java.awt.Color(236, 196, 51));
        ...
        jPanel4.setBackground(new java.awt.Color(17, 122, 122));
        ...
        jPanel5.setBackground(new java.awt.Color(28, 87, 189));
        ...
        label1.setText("Designed By Bivek Jaiswal & Aranya S");
        ...
        MainF.getAccessibleContext().setAccessibleName("PIS");
