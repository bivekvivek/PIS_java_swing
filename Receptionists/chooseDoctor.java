...
public class chooseDoctor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dSearchbox = new javax.swing.JComboBox<String>();
        ...
        jPanel5.setBackground(new java.awt.Color(32, 141, 35));
    ...
    private void dASearchbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dASearchbtnMouseClicked
        ...
        String sql = "select count,date,id,name,age,gender,blood,dept,phone,email,status,address,room,username from doctor where dept LIKE '%" + searchKey + "%'";
        try {
